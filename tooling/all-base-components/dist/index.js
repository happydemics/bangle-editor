import { history, bold, code, italic, strike, link, underline, doc, text, paragraph, blockquote, bulletList, codeBlock, hardBreak, heading, horizontalRule, listItem, orderedList, image } from '@bangle.dev/base-components';
...
export { defaultPlugins, defaultSpecs, options };
