import { TextSelection, Selection, NodeSelection, Fragment } from '@bangle.dev/pm';
import { browser, assertNotUndefined, weakCache, objectMapValues, matchAllPlus } from '@bangle.dev/utils';
...
const getDocLabels = weakCache((doc) => {
    let result = {};
