...
var arrow__default = /*#__PURE__*/_interopDefaultLegacy(arrow);
var flip__default = /*#__PURE__*/_interopDefaultLegacy(flip);
var offset__default = /*#__PURE__*/_interopDefaultLegacy(offset);
var popperOffsets__default = /*#__PURE__*/_interopDefaultLegacy(popperOffsets);
var preventOverflow__default = /*#__PURE__*/_interopDefaultLegacy(preventOverflow);
    ...
    class TooltipPlacementView {
        ...
        _createPopperInstance(view) {
            ...
            const defaultModifiers = [
                offset__default["default"],
                preventOverflow__default["default"],
                flip__default["default"],
                {
                    name: 'offset',
                    options: {
                        offset: (popperState) => {
                ...
                popperOffsets__default["default"],
                showTooltipArrow ? arrow__default["default"] : undefined,
                showTooltipArrow
                    ? {
                        name: 'arrow',
                        options: {
