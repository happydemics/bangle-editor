...
const BangleEditor = React__default["default"].forwardRef(({ id, state, children, focusOnInit = true, pmViewOpts, renderNodeViews, className, style, onReady = () => { }, }, ref) => {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        nodeViews.map((nodeView) => {
            ...
            // @ts-ignore
            React__default["default"].createElement(NodeViewWrapper, { debugKey: utils.objectUid.get(nodeView), nodeViewUpdateStore: nodeViewUpdateStore, nodeView: nodeView, renderNodeViews: renderNodeViews }), nodeView.containerDOM, utils.objectUid.get(nodeView));
        }),
