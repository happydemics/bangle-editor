...
const BangleEditor = React.forwardRef(({ id, state, children, focusOnInit = true, pmViewOpts, renderNodeViews, className, style, onReady = () => { }, }, ref) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        nodeViews.map((nodeView) => {
            return reactDOM.createPortal(React.createElement(NodeViewWrapper, { debugKey: objectUid.get(nodeView), nodeViewUpdateStore: nodeViewUpdateStore, nodeView: nodeView, renderNodeViews: renderNodeViews }), nodeView.containerDOM, objectUid.get(nodeView));
        }),
